...
const ModalForm = ({selTime,selectedDate,toggleModal,handleModal}) => {
    return (
        <div className={`${toggleModal ? 'block' : 'hidden'} w-[90%] mx-auto md:w-3/4 lg:w-2/5 z-[2] fixed left-1/2 transform -translate-x-1/2 -translate-y-1/2 top-1/2 bg-[#fbfbfb] rounded-2xl px-5 py-3 border`}>
            ...
            <p className={`text-black my-10 rounded-lg bg-neutral-300 px-2 md:p-2 lg:p-5`}>{format(selectedDate,'PP')}</p>
            <p className={`text-black my-10 rounded-lg bg-neutral-300 px-2 md:p-2 lg:p-5`}>{selTime}</p>
            <div className={`my-10`}>
                <input type="text" className={`w-full text-black border rounded-lg bg-transparent px-2 md:p-2 lg:p-5`} name={`fullName`} placeholder={`FullName`} />
            </div>
            <div className={`my-10`}>
            ...
            <div className={`my-10`}>
                <input type="text" className={`w-full text-black border rounded-lg bg-transparent px-2 md:p-2 lg:p-5`} name={`email`} placeholder={`Email`} />
            </div>
